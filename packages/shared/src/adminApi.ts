// ============================================================
// Restaurante Pro — API Admin (CRUD productos, categorías, mesas, etc.)
// ============================================================
// Usada por las apps admin-mobile y desktop.
...
// Categorías
// ============================================================
export async function fetchCategories(supabase: SupabaseClient, restaurantId: string) {
...
export async function createCategory(
  ...
  category: { restaurant_id: string; name: string; sort_order?: number }
) {
  const { data, error } = await supabase
    .from('categories')
    .insert(category)
...
// Productos
// ============================================================
export async function fetchProducts(supabase: SupabaseClient, restaurantId: string) {
  const { data, error } = await supabase
    .from('products')
...
// Mesas
// ============================================================
export async function fetchTables(supabase: SupabaseClient, restaurantId: string) {
  const { data, error } = await supabase
    .from('tables')
    .select('*')
    .eq('restaurant_id', restaurantId)
...
export async function createTable(
  supabase: SupabaseClient,
  table: { restaurant_id: string; number: string; capacity?: number }
) {
  const { data, error } = await supabase
    .from('tables')
    .insert(table)
...
export async function deleteTable(supabase: SupabaseClient, id: string) {
...
// Ingredientes
// ============================================================
export async function fetchIngredients(supabase: SupabaseClient, restaurantId: string) {
  const { data, error } = await supabase
    .from('ingredients')
    .select('*')
    .eq('restaurant_id', restaurantId)
...
// ============================================================
export async function fetchDashboardStats(supabase: SupabaseClient, restaurantId: string) {
...
// Usuarios / Empleados
// ============================================================
export async function fetchUsers(supabase: SupabaseClient, restaurantId: string) {
  const { data, error } = await supabase
    .from('users')
    .select('*, role:roles(*)')
    .eq('restaurant_id', restaurantId)
...
export async function inviteStaffUser(
  supabase: SupabaseClient,
  params: { email: string; fullName: string; roleName: string; restaurantId: string }
) {
